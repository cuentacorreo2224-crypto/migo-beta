...
export default function MigoBeta() {
  ...
  if (searchResult) {
    return (
      <div style={{ position: 'fixed', inset: 0, background: 'linear-gradient(135deg, #10b981, #06b6d4)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ backgroundColor: 'white', padding: '48px 28px', borderRadius: '28px', maxWidth: '420px', width: '100%', textAlign: 'center' }}>
          <div style={{ fontSize: '78px', marginBottom: '24px' }}>🐾</div>
  ...
  // ====================== PANTALLA PRINCIPAL - DISEÑO ELEGANTE MINIMALISTA ======================
  return (
    <div style={{ 
      position: 'fixed', 
      inset: 0, 
      ...
      <div style={{ textAlign: 'center', marginBottom: '52px' }}>
        <div style={{ margin: '0 auto 18px', width: '108px', height: '108px', background: 'linear-gradient(135deg, #34d399, #22d3ee)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '64px' }}>
          🐾
        </div>
        <h1 style={{ fontSize: '38px', fontWeight: '700', letterSpacing: '-1.5px', margin: 0 }}>MIGO Beta</h1>
        <p style={{ color: '#34d399', fontSize: '19px', marginTop: '6px' }}>DNI GRATIS PARA PERRITOS</p>
      </div>

      {/* Tabs Elegantes */}
      <div style={{ backgroundColor: '#1a2338', padding: '6px', borderRadius: '9999px', display: 'flex', marginBottom: '44px' }}>
        <button 
      ...
      {/* Contenido Principal - Equilibrado */}
      <div style={{ backgroundColor: '#1a2338', padding: '32px', borderRadius: '28px' }}>
        ...
        {image && (
          <div style={{ marginTop: '28px', borderRadius: '20px', overflow: 'hidden', border: '2px solid #334155' }}>
            ...
            {tab === 'register' && (
              <>
                <input 
                  ...
                  style={{ width: '100%', padding: '18px', backgroundColor: '#111827', borderRadius: '16px', fontSize: '17.5px', marginBottom: '12px', color: 'white', border: 'none' }}
                />
                <input 
                  type="tel" 
                  ...
                  style={{ width: '100%', padding: '18px', backgroundColor: '#111827', borderRadius: '16px', fontSize: '17.5px', color: 'white', border: 'none' }}
                />
              </>
            )}
      ...
      {showHowToUse && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.96)', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
          <div style={{ backgroundColor: '#1e2937', borderRadius: '28px', padding: '32px', maxWidth: '420px', width: '100%', maxHeight: '90vh', overflowY: 'auto' }}>
            <h2 style={{ fontSize: '28px', fontWeight: '700', textAlign: 'center', marginBottom: '28px' }}>¿Cómo usar MIGO Beta?</h2>
